...
a persistence unit "plataforma-interoperabilidadPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "plataforma-interoperabilidad\pom.xml":
...
artifact ("plataforma-interoperabilidad.war") is already built. You can build
